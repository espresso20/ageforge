...
func buildingsLineageEngineering() []BuildingDef {
	...
	b = append(b, BuildingDef{
		...
		Description: "Water-powered mill begins steel production. +1.60 steel/tick (6 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Naval dockyard producing steel ships. +3.20 steel/tick (7 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Large-scale industrial iron and steel works. +6.40 steel/tick (8 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Steam-powered steelworks with electricity generation. +12.80 steel, +5.0 electricity/tick (9 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Coal-fired power station. +25.60 electricity/tick (10 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Nuclear fission power generation. +51.20 electricity/tick (11 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Smart power grid distribution hub. +102.40 electricity/tick (12 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "AI-managed smart grid node. +204.80 electricity/tick (13 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Neural-network managed power grid. +409.60 electricity/tick (14 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Cyberpunk foundry producing plasma and power. +819.20 plasma, +500 electricity/tick (15 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Fusion reactor generating plasma and electricity. +1638.40 plasma, +1000 electricity/tick.",
	...
	b = append(b, BuildingDef{
		...
		Description: "Space launch complex generating plasma thrust. +3276.80 plasma/tick (20 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Warp drive manufacturing harnessing dark matter. +6553.60 dark_matter/tick (22 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Assembly of Dyson sphere panels harvesting dark matter. +13107.20 dark_matter/tick (25 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "Forges structures from the quantum fabric. +26214.40 quantum_flux/tick (30 workers).",
	...
	b = append(b, BuildingDef{
		...
		Description: "A singularity-powered engine generating quantum flux. +52428.80 quantum_flux/tick (35 workers).",
