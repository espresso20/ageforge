...
func Ages() []AgeDef {
	return []AgeDef{
		// === 0: PRIMITIVE AGE (Stone Era) ===
		{
			...
			UnlockBuildings: []string{"hut", "stash", "gathering_camp", "wood_camp", "stone_camp", "story_circle", "shrine", "hunting_lodge", "sacred_grove"},
		...
		// === 1: STONE AGE (Stone Era) ===
		{
			...
			UnlockBuildings: []string{"longhouse", "storage_pit", "forager_post", "woodcutter_camp", "stone_pit", "elders_hall", "standing_stones", "war_camp", "great_monolith"},
		...
		// === 3: IRON AGE (Iron Era) ===
		{
			...
			UnlockBuildings: []string{"townhouse", "granary", "field_works", "timber_yard", "marble_quarry", "agora", "temple", "legion_fort", "trading_post", "ironworks", "smelter", "colosseum"},
		...
		// === 4: CLASSICAL AGE (Iron Era) ===
		{
			...
			BuildingReqs:    map[string]int{"barracks": 15, "library": 8, "market": 5},
		...
		// === 7: COLONIAL AGE (Steel Era) ===
		{
			...
			BuildingReqs:    map[string]int{"bank": 5, "university": 3, "art_studio": 5},
		...
		// === 10: ELECTRIC AGE (Electric Era) ===
		{
			...
			BuildingReqs:    map[string]int{"power_generator": 20, "academy": 10, "steel_mill": 15},
		...
		// === 14: DIGITAL AGE (Digital Era) ===
		{
			...
			BuildingReqs:    map[string]int{"server_farm": 30, "media_center": 80, "data_center": 30},
