...
func BaseBuildings() []BuildingDef {
	return []BuildingDef{
		...
		},
		{
			...
			CostScale:   1.35,
			Effects:     []Effect{{Type: "production", Target: "knowledge", Value: 0.025}},
			BuildTicks:  3,
			RequiredAge: "primitive_age",
			Description: "A sacred stone circle where shamans commune with spirits. +0.025 knowledge/tick.",
		},
		...
		},
		{
			...
			BuildTicks:  5,
			RequiredAge: "stone_age",
			Description: "Elders share stories by the fire. +0.05 knowledge/tick.",
		},
		{
		...
		},
		{
			...
			CostScale:   1.35,
			Effects:     []Effect{{Type: "production", Target: "knowledge", Value: 0.15}},
			BuildTicks:  8,
			RequiredAge: "bronze_age",
			Description: "Scribes record and study. +0.15 knowledge/tick.",
		},
		{
		...
		// ===== CLASSICAL AGE (costs: 40k-120k) =====
		{
			...
			Description: "Center of civic life. +0.25 gold, +0.15 knowledge/tick.",
		},
		{
		...
		},
		{
			...
			CostScale:   1.45,
			Effects:     []Effect{{Type: "production", Target: "knowledge", Value: 0.75}},
			BuildTicks:  20,
			RequiredAge: "medieval_age",
			Description: "Advanced learning. +0.75 knowledge/tick.",
		},
		{
		...
		},
		{
			...
			CostScale:   1.5,
			Effects:     []Effect{{Type: "production", Target: "knowledge", Value: 1.0}},
			BuildTicks:  25,
			RequiredAge: "renaissance_age",
			MaxCount:    3,
			Description: "Studies the stars. +1.0 knowledge/tick. Max 3.",
		},
		{
