...
func buildingsLineageMilitary() []BuildingDef {
	...
	b = append(b, BuildingDef{
		...
		BaseCost:    map[string]float64{"quantum_flux": 2.1e15, "antimatter": 620e15, "dark_matter": 520e15},
		CostScale:   1.35,
		Effects:     []Effect{{Type: "capacity", Target: "military", Value: 20971520}},
		BuildTicks:  3600,
		RequiredAge: "transcendent_age",
		Description: "Commands forces across the omniverse. +20971520 military cap (35 workers).",
