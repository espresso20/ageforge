...
**Boons are capped at three.** You can hold **three** faction boons at once. Only *timed* rewards occupy a slot — an instant lump of resources is unpacked on arrival and holds nothing. While all three slots are full, further encounters return empty-handed (*"Your stores are already thick with foreign gifts; the envoys are thanked, fed, and sent home with their crates unopened"*) until one expires. Boons are therefore a scarce resource to **time and spend**, not something you stack indefinitely — running expedition after expedition on top of three live buffs mostly burns them.

**Encounters can go badly.** A **setback** rolls in place of a boon whenever the expedition **failed**, whenever the civ you met is one you are **at war** with — both of those every time, not by chance — and about **one in four** times an encounter arrives while you're already at boon capacity. Setbacks come off their own table: people lost on the way home (a handful of workers gone to fever or bad water), a share of one resource stockpile spoiled, stolen, or written off, a temporary slump in one resource's output, or a realm-wide production dip while the story of the expedition spreads. Severity scales **up** with the civilization's **strength** and **down** with your **standing** — an ally's bad news is gentler than a rival's, and a war with a strong civ is the worst of it. The damage is bounded: at most three timed setbacks run at a time, and a spoilage takes part of a store, never the whole thing.

Encounters are one more reason to keep expeditions running even after you've met everyone — with the caveat that a failed run now brings back a bill, and a run launched with your boon slots full mostly brings back nothing. See [Military & Expeditions](military.md#faction-encounters).
